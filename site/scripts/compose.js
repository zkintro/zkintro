...
inquirer
  ...
  .then((answers) => {
    ...
    if (!fs.existsSync('../content/en')) fs.mkdirSync('../content/en', { recursive: true })
    const filePath = `../content/en/${fileName ? fileName : 'untitled'}.${answers.extension ? answers.extension : 'md'
      }`
